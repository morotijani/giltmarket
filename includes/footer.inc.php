                            ...
                            <div id="result-view">
                                ...
                                <div class="d-flex flex-wrap gap-1 gap-sm-2">
                                    <div class="w-sm-56 input-group input-group-sm input-group-inline">
                                        <input type="text" readonly class="form-control fw-semibold fs-5" placeholder="0.00" id="total-amount" style="border: none; color: green;"> <span class="input-group-text">₵</span>
                                    </div>
                                    <div class="flex-fill">
                                    ...
                                    <?php if (is_capital_given()): ?>
                                        <?php if (is_capital_exhausted($conn, $admin_data['admin_id'])): ?>
                                            ...
                                            <div class="d-flex justify-content-between p-4 bg-body-secondary rounded">
                                                <input type="password" class="form-control form-control-flush text-xl fw-bold w-rem-40" placeholder="0000" name="pin" id="pin" autocomplete="off" inputmode="numeric" data-maxlength="4" oninput="this.value=this.value.slice(0,this.dataset.maxlength)">
                                                <div class="dropdown">
				...
				<form method="POST" id="fundCoffersForm" action="<?= PROOT; ?>auth/add.amount.to.coffers.php" autocomplete="off">
					<div class="modal-body">
						...
						<div class="">
							...
							<input type="number" inputmode="numeric" class="form-control" placeholder="0.00" name="add_amount" id="add_amount" autocomplete="off" min="0.00" step="0.01" required />
						</div>
					</div>
    ...
    <div aria-live="polite" aria-atomic="true" class="d-flex justify-content-center align-items-center w-100">
        <div id="live-toast" class="toast fade hide position-fixed rounded" role="alert" aria-live="assertive" aria-atomic="true" style="background-color: #6e46cc; right: 6px; bottom: 0; z-index: 99999;">
            <div class="toast-header small p-1 border-bottom">
                <img src="<?= PROOT; ?>assets/media/giltmarket-logo.png" style="width: 25px; height: 25px;" class="img-fluid rounded me-2" alt="Giltmarket Logo">
                <strong class="me-auto small">Giltmarket</strong>
