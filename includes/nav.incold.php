					...
					<div class="container px-sm-0">
						...
						<div class="collapse navbar-collapse" id="navbarCollapse">
							...
							<div class="navbar-nav align-items-lg-center justify-content-end gap-2 ms-lg-4 w-lg-64">
								<?php if (admin_is_logged_in()): ?>
								<a class="nav-item nav-link rounded-pill d-none d-lg-block" href="<?= PROOT; ?>acc/profile">Hello <?= $admin_data['first'] . "! <span class='badge bg-primary-subtle text-primary rounded-pill'>". _admin_position($admin_data['admin_permissions']); ?></span></a>
								<?php else: ?>
